...
use Omnipay\Tokenflex\Message\VoidRequest;
use Omnipay\Tokenflex\Message\VoidResponse;
...
class VoidTest extends TestCase
{
    ...
    public function test_void_response(): void
    {
        $response_data = [
            'Status'      => 1,
            'Code'        => null,
        ...
        $expected = new VoidResponseModel([
            'Status'      => 1,
            'Code'        => null,
            'Message'     => 'message',
            'Description' => 'description',
